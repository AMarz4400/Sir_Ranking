# -*- encoding: utf-8 -*-
import itertools  # Extra
import json
import time
import random
import math
import fire
import pandas as pd  # Extra
import shutil  # Extra
import os  # os
...
def args(type=None):
    ...
    if type == "using":
        kwargs = {
            ...
            'pth_path': './checkpoints/DeepCoNN_Digital_Music_data_default.pth',
            'model': 'DeepCoNN',
        }
